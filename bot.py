...
class ItemEntryView(discord.ui.View):
    ...
    async def submit_item(self, interaction: discord.Interaction):
        ...
        if self.item_id:  # editing
            ...
            await add_item_db(guild_id=interaction.guild.id, item_id=self.item_id, name=self.item_name, type_=self.item_type, subtype=self.subtype, stats=self.stats, classes=classes_str)
